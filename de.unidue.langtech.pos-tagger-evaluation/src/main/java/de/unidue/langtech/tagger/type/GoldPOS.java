...
/* First created by JCasGen Wed Apr 01 22:20:03 CEST 2015 */
package de.unidue.langtech.tagger.type;
...
/** 
 * Updated by JCasGen Tue Apr 28 10:17:53 CEST 2015
 * XML source: /Users/Tobias/Documents/Eclipse/pos-tagger-evaluation/de.unidue.langtech.teaching.pos-tagger-evaluation/src/main/resources/desc/type/POSType.xml
 * @generated */
  ...
  */  
  ...
  public POS getPosTag() {
    if (GoldPOS_Type.featOkTst && ((GoldPOS_Type)jcasType).casFeat_posTag == null)
      jcasType.jcas.throwFeatMissing("posTag", "de.unidue.langtech.tagger.type.GoldPOS");
  ...
  public String getCPosTag() {
    if (GoldPOS_Type.featOkTst && ((GoldPOS_Type)jcasType).casFeat_cPosTag == null)
      jcasType.jcas.throwFeatMissing("cPosTag", "de.unidue.langtech.tagger.type.GoldPOS");
