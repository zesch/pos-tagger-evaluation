...
public class GoldPOS_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("de.unidue.langtech.tagger.type.GoldPOS");
  ...
  public int getPosTag(int addr) {
      ...
      jcas.throwFeatMissing("posTag", "de.unidue.langtech.tagger.type.GoldPOS");
  ...
  public String getCPosTag(int addr) {
      ...
      jcas.throwFeatMissing("cPosTag", "de.unidue.langtech.tagger.type.GoldPOS");
