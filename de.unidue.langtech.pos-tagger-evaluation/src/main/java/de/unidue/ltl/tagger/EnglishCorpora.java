...
public class EnglishCorpora implements Keys {
	...
	public static NamedCorpusReaderDescription getWrittenGumNews() throws Exception {
		CollectionReaderDescription desc = CollectionReaderFactory.createReaderDescription(LinewiseTokenTagReader.class,
				LinewiseTokenTagReader.PARAM_SOURCE_LOCATION, corporaFolderPrefix + "/english/formal/gum-news/",
				LinewiseTokenTagReader.PARAM_LANGUAGE, LANG, LinewiseTokenTagReader.PARAM_PATTERNS, "*.txt",
				LinewiseTokenTagReader.PARAM_POS_MAPPING_LOCATION, mappingFolderPrefix + "/en-ptb-tt-pos.map");
	...
	public static NamedCorpusReaderDescription getWrittenGumVoyage() throws Exception {
		CollectionReaderDescription desc = CollectionReaderFactory.createReaderDescription(LinewiseTokenTagReader.class,
				LinewiseTokenTagReader.PARAM_SOURCE_LOCATION, corporaFolderPrefix + "/english/formal/gum-voyage/",
				LinewiseTokenTagReader.PARAM_LANGUAGE, LANG, LinewiseTokenTagReader.PARAM_PATTERNS, "*.txt",
				LinewiseTokenTagReader.PARAM_POS_MAPPING_LOCATION, mappingFolderPrefix + "/en-ptb-tt-pos.map");
	...
	public static NamedCorpusReaderDescription getWrittenGumHowto() throws Exception {
		CollectionReaderDescription desc = CollectionReaderFactory.createReaderDescription(LinewiseTokenTagReader.class,
				LinewiseTokenTagReader.PARAM_SOURCE_LOCATION, corporaFolderPrefix + "/english/formal/gum-howto/",
				LinewiseTokenTagReader.PARAM_LANGUAGE, LANG, LinewiseTokenTagReader.PARAM_PATTERNS, "*.txt",
				LinewiseTokenTagReader.PARAM_POS_MAPPING_LOCATION, mappingFolderPrefix + "/en-ptb-tt-pos.map");
	...
	public static NamedCorpusReaderDescription getWrittenBnc100k() throws Exception {
		CollectionReaderDescription desc = CollectionReaderFactory.createReaderDescription(LinewiseTokenTagReader.class,
				LinewiseTokenTagReader.PARAM_SOURCE_LOCATION, corporaFolderPrefix + "/english/formal/bnc-written-news/",
				LinewiseTokenTagReader.PARAM_LANGUAGE, LANG, LinewiseTokenTagReader.PARAM_PATTERNS, "*.txt",
				LinewiseTokenTagReader.PARAM_POS_MAPPING_LOCATION, mappingFolderPrefix + "/" + "en-c5-pos.map");
	...
	public static NamedCorpusReaderDescription getWrittenBrown() throws Exception {
		CollectionReaderDescription desc = CollectionReaderFactory.createReaderDescription(LinewiseTokenTagReader.class,
				LinewiseTokenTagReader.PARAM_SOURCE_LOCATION, corporaFolderPrefix + "/english/formal/brown/",
				LinewiseTokenTagReader.PARAM_LANGUAGE, LANG, LinewiseTokenTagReader.PARAM_PATTERNS, "*.txt",
				LinewiseTokenTagReader.PARAM_POS_MAPPING_LOCATION, mappingFolderPrefix + "/" + "en-browntei-pos.map");
	...
	public static NamedCorpusReaderDescription getSocialGimpel() throws Exception {
		CollectionReaderDescription desc = CollectionReaderFactory.createReaderDescription(LinewiseTokenTagReader.class,
				LinewiseTokenTagReader.PARAM_SOURCE_LOCATION, corporaFolderPrefix + "/english/social/gimpel/",
				LinewiseTokenTagReader.PARAM_LANGUAGE, LANG, LinewiseTokenTagReader.PARAM_PATTERNS, "*.txt",
				LinewiseTokenTagReader.PARAM_POS_MAPPING_LOCATION, mappingFolderPrefix + "/" + "en-arktweet-pos.map");
	...
	public static NamedCorpusReaderDescription getSocialNpsIrcChat() throws Exception {
		...
		CollectionReaderDescription desc = CollectionReaderFactory.createReaderDescription(LinewiseTokenTagReader.class,
				LinewiseTokenTagReader.PARAM_SOURCE_LOCATION, corporaFolderPrefix + "/english/social/nps-irc/",
				LinewiseTokenTagReader.PARAM_LANGUAGE, LANG, LinewiseTokenTagReader.PARAM_PATTERNS, "*.txt",
				LinewiseTokenTagReader.PARAM_POS_MAPPING_LOCATION, mappingFolderPrefix + "/" + defaultMap);
	...
	public static NamedCorpusReaderDescription getSocialRitterTwitter() throws Exception {
		CollectionReaderDescription desc = CollectionReaderFactory.createReaderDescription(LinewiseTokenTagReader.class,
				LinewiseTokenTagReader.PARAM_SOURCE_LOCATION, corporaFolderPrefix + "/english/social/ritter/",
				LinewiseTokenTagReader.PARAM_LANGUAGE, LANG, LinewiseTokenTagReader.PARAM_PATTERNS, "*.txt",
				LinewiseTokenTagReader.PARAM_POS_MAPPING_LOCATION, mappingFolderPrefix + "/" + defaultMap);
	...
	public static NamedCorpusReaderDescription getSocialAaveTwitter() throws Exception {
		CollectionReaderDescription desc = CollectionReaderFactory.createReaderDescription(LinewiseTokenTagReader.class,
				LinewiseTokenTagReader.PARAM_SOURCE_LOCATION, corporaFolderPrefix + "/english/social/aaveTweets/",
				LinewiseTokenTagReader.PARAM_LANGUAGE, LANG, LinewiseTokenTagReader.PARAM_PATTERNS, "*.txt",
				LinewiseTokenTagReader.PARAM_POS_MAPPING_LOCATION, mappingFolderPrefix + "/" + "en-aavee-pos.map");
	...
	public static NamedCorpusReaderDescription getSpokenSwitchboard() throws Exception {
		CollectionReaderDescription desc = CollectionReaderFactory.createReaderDescription(LinewiseTokenTagReader.class,
				LinewiseTokenTagReader.PARAM_SOURCE_LOCATION, corporaFolderPrefix + "/english/spoken/switchboard/",
				LinewiseTokenTagReader.PARAM_LANGUAGE, LANG, LinewiseTokenTagReader.PARAM_PATTERNS, "*.txt",
				LinewiseTokenTagReader.PARAM_POS_MAPPING_LOCATION, mappingFolderPrefix + "/" + defaultMap);
	...
	public static NamedCorpusReaderDescription getSpokenTedTalk() throws Exception {
		CollectionReaderDescription desc = CollectionReaderFactory.createReaderDescription(LinewiseTokenTagReader.class,
				LinewiseTokenTagReader.PARAM_SOURCE_LOCATION, corporaFolderPrefix + "/english/spoken/tedTalk/",
				LinewiseTokenTagReader.PARAM_LANGUAGE, LANG, LinewiseTokenTagReader.PARAM_PATTERNS, "*.txt",
				LinewiseTokenTagReader.PARAM_POS_MAPPING_LOCATION, mappingFolderPrefix + "/" + defaultMap);
	...
	public static NamedCorpusReaderDescription getSpokenBnc() throws Exception {
		CollectionReaderDescription desc = CollectionReaderFactory.createReaderDescription(LinewiseTokenTagReader.class,
				LinewiseTokenTagReader.PARAM_SOURCE_LOCATION,
				corporaFolderPrefix + "/english/spoken/bnc-conversations/", LinewiseTokenTagReader.PARAM_LANGUAGE, LANG,
				LinewiseTokenTagReader.PARAM_PATTERNS, "*.txt", LinewiseTokenTagReader.PARAM_POS_MAPPING_LOCATION,
	...
	public static NamedCorpusReaderDescription getSpokenGumInverview() throws Exception {
		CollectionReaderDescription desc = CollectionReaderFactory.createReaderDescription(LinewiseTokenTagReader.class,
				LinewiseTokenTagReader.PARAM_SOURCE_LOCATION, corporaFolderPrefix + "/english/spoken/gum-inverview/",
				LinewiseTokenTagReader.PARAM_LANGUAGE, LANG, LinewiseTokenTagReader.PARAM_PATTERNS, "*.txt",
				LinewiseTokenTagReader.PARAM_POS_MAPPING_LOCATION, mappingFolderPrefix + "/en-ptb-tt-pos.map");
