...
/* First created by JCasGen Thu May 01 16:36:36 CEST 2014 */
  ...
  */  
  ...
  public String getPosTag() {
    if (GoldPOS_Type.featOkTst && ((GoldPOS_Type)jcasType).casFeat_posTag == null)
      jcasType.jcas.throwFeatMissing("posTag", "de.unidue.langtech.teaching.pp.type.GoldPOS");
    return jcasType.ll_cas.ll_getStringValue(addr, ((GoldPOS_Type)jcasType).casFeatCode_posTag);}
  ...
  public void setPosTag(String v) {
    if (GoldPOS_Type.featOkTst && ((GoldPOS_Type)jcasType).casFeat_posTag == null)
      jcasType.jcas.throwFeatMissing("posTag", "de.unidue.langtech.teaching.pp.type.GoldPOS");
    jcasType.ll_cas.ll_setStringValue(addr, ((GoldPOS_Type)jcasType).casFeatCode_posTag, v);}    
  }
